...
public class TomlWriterTest {
  ...
  public void should_reject_heterogeneous_arrays() {
    ...
    IllegalStateException e = assertThrows(IllegalStateException.class, () -> new TomlWriter().write(badArray));
    assertTrue(e.getMessage().startsWith("array"));
  }
  ...
  public void should_reject_nested_heterogeneous_array() {
    ...
    IllegalStateException e = assertThrows(IllegalStateException.class, () -> new TomlWriter().write(badArray));
    assertTrue(e.getMessage().contains("aMap.array"));
  }
  ...
  @Test
  public void should_write_to_file(@TempDir Path testDirectory) throws IOException {
    File output = testDirectory.resolve("temp.txt").toFile();
    new TomlWriter().write(new SimpleTestClass(), output);
  ...
  public void should_refuse_to_write_number_fragment() {
	  assertThrows(IllegalArgumentException.class, () -> new TomlWriter().write(42));
  }
