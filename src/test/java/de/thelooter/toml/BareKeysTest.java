...
public class BareKeysTest {
  ...
  @Test
  public void should_fail_when_characters_outside_accept_range_are_used_in_table_name() {
    assertThrows(IllegalStateException.class, () -> new Toml().read("[~]"));
  }

  @Test
  public void should_fail_when_characters_outside_accept_range_are_used_in_table_array_name() {
    assertThrows(IllegalStateException.class, () -> new Toml().read("[[~]]"));
  }
  
  @Test
  public void should_fail_when_dots_in_key_name() {
    assertThrows(IllegalStateException.class, () -> new Toml().read("a.b = 1"));
  }

  @Test
  public void should_fail_when_characters_outside_accept_range_are_used_in_key_name() {
    assertThrows(IllegalStateException.class, () -> new Toml().read("~ = 1"));
  }

  @Test
  public void should_fail_on_sharp_sign_in_table_name() {
    assertThrows(IllegalStateException.class, () -> new Toml().read("[group#]\nkey=1"));
  }
  
  @Test
  public void should_fail_on_spaces_in_table_name() {
    assertThrows(IllegalStateException.class, () -> new Toml().read("[valid  key]"));
  }

  @Test
  public void should_fail_on_sharp_sign_in_table_array_name() {
    assertThrows(IllegalStateException.class, () -> new Toml().read("[[group#]]\nkey=1"));
  }
  
  @Test
  public void should_fail_on_spaces_in_table_array_name() {
    assertThrows(IllegalStateException.class, () -> new Toml().read("[[valid  key]]"));
  }

  @Test
  public void should_fail_on_question_marks_in_key_name() {
