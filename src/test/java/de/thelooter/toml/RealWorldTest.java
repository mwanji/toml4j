...
public class RealWorldTest {
  ...
  public void should_parse_hard_example() throws Exception {
    Toml toml = new Toml().read(new File("src/test/resources/de/thelooter/toml/hard_example.toml"));
  ...
  public void should_parse_current_version_example() throws Exception {
    Toml toml = new Toml().read(new File("src/test/resources/de/thelooter/toml/example-v0.4.0.toml"));
